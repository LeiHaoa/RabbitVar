...
datas=(
		...
		/home/old_home/haoz/workspace/FastVC/detection_result/somatic/train_set_10_18/FDSynthetic.notloose.txt /home/old_home/haoz/workspace/FastVC/detection_result/dreamsim_1227/dreamsim_1227.txt 
...
time python train_rf.py \
		 --tsv data_indel.tsv \
		 --var_type "INDEL" \
		 --out_model ./models/som_indel_0111.pkl  \
...
time python train_rf.py \
		 --tsv data_snv.tsv \
		 --var_type "SNV" \
		 --out_model ./models/som_snv_0111.pkl  \
