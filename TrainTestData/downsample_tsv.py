...
print(len(truth_data), len(false_data))
...
#---------------all HCC data--------------#
tsv = "./data_INDEL_HCC1395_ALL.tsv"
HCC1395_data = get_data_fromcsv(tsv, [*features.som_rf_indel_input_features, 'Label'], "INDEL")
...
aug_data.to_csv("./data_INDEL_HCC1395_ALL_SYNCS_DOWNSAMPLE.tsv",index = False)
